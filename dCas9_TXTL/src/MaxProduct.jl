...
flux_model = flux_model_dictionary["PROTEIN_export_dCas9"];
...
plasmid_concentration = 0.788;
data_dictionary["dCas9_gene_copies"] = (10e-6/1e9)*(6.02e23)*plasmid_concentration;
