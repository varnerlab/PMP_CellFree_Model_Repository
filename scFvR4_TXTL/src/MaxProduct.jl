...
flux_model = flux_model_dictionary["PROTEIN_export_scFvR4"];
...
plasmid_concentration = 0.667;
data_dictionary["scFvR4_gene_copies"] = (10e-6/1e9)*(6.02e23)*plasmid_concentration;
